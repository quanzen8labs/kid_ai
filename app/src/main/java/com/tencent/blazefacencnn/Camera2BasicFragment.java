...
public class Camera2BasicFragment extends Fragment
    ...
    public  BlazeFaceNcnn blazeFaceNcnn;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        rectangleOverlay = (RectangleOverlay)view.findViewById(R.id.rectangle_overlay);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("Request permission failed")
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("Something went wrong")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }
